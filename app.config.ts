...
const rawBundleId = "space.manus.razor.field.app.t20260425092026";
const bundleId =
  rawBundleId
...
const config: ExpoConfig = {
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow $(PRODUCT_NAME) to access your camera to scan serial numbers and barcodes.",
      },
    ],
    [
      "expo-audio",
